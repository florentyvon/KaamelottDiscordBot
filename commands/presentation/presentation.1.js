  ...
  async run(message) {
    ...
    new Promise((resolve, reject) => {
      ...
      .then(async function() {
        ...
        .then(async function() {
            message.channel.send(citationsTTS[13], { tts: true });
              ...
              .then(async function() {
                VC.join()
                  .then(connection => {
                    ...
                    dispatcher.on("end", end => {
                      connection.playFile(path + citationsAudio[2]);
                      dispatcher.on("end", end => {
                        VC.leave();
                      });
                    });
                    ...
                    new Promise((resolve, reject) => {
                      ...
                      .then(async function() {
                        ...
                        new Promise((resolve, reject) => {
                          ...
                          .then(async function() {
                            message.channel.send(citationsTTS[3], {
                              tts: true
                            });
